...
func (c *encoderProtobufClient) CreateStream(ctx context.Context, in *CreateStreamRequest) (*CreateStreamResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "decode.thingful.encoder")
...
const EncoderPathPrefix = "/twirp/decode.thingful.encoder.Encoder/"
...
func (s *encoderServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/decode.thingful.encoder.Encoder/CreateStream":
		s.serveCreateStream(ctx, resp, req)
		return
	case "/twirp/decode.thingful.encoder.Encoder/DeleteStream":
